...
//        }
    ...
    func setCustomView() {
        self.layer.borderColor = #colorLiteral(red: 0.275936842, green: 0.1149172261, blue: 0.4860839248, alpha: 1)//UIColor(red: 0, green: 153, blue: 212, alpha: 1.0).cgColor
        self.layer.borderWidth = 1.5
        self.layer.cornerRadius = 6

    }
    
    func setCustomYellowView() {
        self.layer.borderColor = #colorLiteral(red: 1, green: 0.9747149348, blue: 0.4545389414, alpha: 1)//UIColor(red: 0, green: 153, blue: 212, alpha: 1.0).cgColor
        self.layer.borderWidth = 1.5
        self.layer.cornerRadius = 6
    ...
    func setNormalTxtView() {
        self.layer.borderColor = #colorLiteral(red: 0.6364975572, green: 0.5565114617, blue: 0.7426373363, alpha: 1)//UIColor(red: 0, green: 153, blue: 212, alpha: 1.0).cgColor
        self.layer.borderWidth = 1
        self.layer.cornerRadius = 6
    }
    
    func setWhiteGrayView() {
        self.layer.borderColor = #colorLiteral(red: 0.925142467, green: 0.9332025647, blue: 0.9455558658, alpha: 1)//UIColor(red: 0, green: 153, blue: 212, alpha: 1.0).cgColor
        self.layer.borderWidth = 1
