...
public class Checkbox: UIControl {
    ...
    /// **Default:** White.
    public var checkboxBackgroundColor: UIColor! = .gray
...
extension Checkbox {
    ...
    func setRounded() {
        let selectedColor = #colorLiteral(red: 0.4542183876, green: 0, blue: 0.8132248521, alpha: 1)
        self.borderWidth = 2
        self.checkedBorderColor = #colorLiteral(red: 0.4542183876, green: 0, blue: 0.8132248521, alpha: 1)
        self.uncheckedBorderColor = #colorLiteral(red: 0.4542183876, green: 0, blue: 0.8132248521, alpha: 1)
        self.borderStyle = .circle
        self.checkmarkStyle = .circle
        self.checkboxBackgroundColor = UIColor.clear
        self.checkmarkColor = selectedColor
    }
    
    func setSquare() {
        let selectedColor = #colorLiteral(red: 0.767175138, green: 0.1698025465, blue: 1, alpha: 1)
        self.borderWidth = 2
        self.checkedBorderColor = selectedColor
        self.uncheckedBorderColor = #colorLiteral(red: 0.767175138, green: 0.1698025465, blue: 1, alpha: 1)
        self.borderStyle = .square
        self.checkmarkStyle = .tick
        self.checkboxBackgroundColor = UIColor.clear
        self.checkmarkColor = selectedColor
    }
...
class CustomCheckBox: UIButton {
    // Images
    let checkedImage = UIImage(named: "chk")! as UIImage
